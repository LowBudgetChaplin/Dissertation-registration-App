...
function HomepageProf({ onLoginSuccess }) {
	...
	const [onePreRequest, setOnePrerequest] = useState({});
	...
	const handlePreRequest = (preRequestId, studentIdForPrereq, action, justification, status) => {
		...
		//primeste request-ul de la student daca este acceptat
		if (status == 'accepted') {
			console.log(studentIdForPrereq);
			console.log(preRequestId);
