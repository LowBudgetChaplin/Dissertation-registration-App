...
function PhaseThree() {
	...
	return <div className="phaseThreeContainer">{currentMainRequest && currentMainRequest?.status == 'accepted' ? 
	<button onClick={handleDownload}>Download request</button> : <div>Nothing yet</div>}</div>;
}
