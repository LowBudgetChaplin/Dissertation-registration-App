	...
	return (
		<div>
			{isMainReqAccepted?.status === 'accepted' ? (
				<div>Your professor accepted your Request Paper! You can download it when its signed.</div>
				...
				<div className="phaseTwoContainer">
					{!isAccepted ? (
						<div>No professor accepted the request</div>
					) : (
						<div className="phaseTwoWrapper">
							<div className="text">{`Congratulations, you were accepted at session ${acceptedSession}`}</div>
							<div className="text">Upload the Request paper! Your professor will notify you if it is accepted or rejected</div>
